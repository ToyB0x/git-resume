            ...
            <div className="glass rounded-lg p-5 border border-gray-800">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-300">
                    Basic information and research plan for the entered GitHub
                    username will be displayed. Review the content and click the
                    "Execute Research" button to start detailed analysis.
                  </p>
                  <div className="mt-3 p-3 bg-gray-800 bg-opacity-50 rounded-lg">
                    <p className="text-sm text-gray-400">
            ...
            <div className="glass rounded-lg p-5 border border-gray-800">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-300">
                    The progress of detailed analysis is displayed in real-time.
                    This process runs in the background, so you can safely leave
            ...
            <div className="glass rounded-lg p-5 border border-gray-800">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-300">
                    When the analysis is complete, a resume in Markdown format
                    will be displayed. You can save it in PDF or text format
                    using the "Export" button, or share the results using the
                    "Share" button.
                  </p>
                  <div className="mt-3 p-3 bg-gray-800 bg-opacity-50 rounded-lg">
                    <p className="text-sm text-gray-400">
                      Tip: Analysis results are stored for 30 days and will be
                      displayed immediately when searching for the same username
                      again.
                    </p>
                  </div>
                </div>
          ...
          <div className="space-y-6">
            <div className="glass rounded-lg p-5 border border-gray-800">
              ...
              <p className="text-gray-300">
                ...
                contributions to generate a comprehensive resume. Only publicly
            ...
            <div className="glass rounded-lg p-5 border border-gray-800">
              ...
              <p className="text-gray-300">
                The analysis time depends on the number of repositories and the
                amount of activity. Typically, it takes about 1 minute per
                repository.
              </p>
            </div>
            ...
            <div className="glass rounded-lg p-5 border border-gray-800">
              ...
              <p className="text-gray-300">
                Currently, the resume is generated automatically based on the
                GitHub activity. Customization features will be added in future
                updates.
              </p>
            </div>
            ...
            <div className="glass rounded-lg p-5 border border-gray-800">
              ...
              <p className="text-gray-300">
                The generated resumes are stored for 30 days. After that, you'll
      ...
      {activeTab === "contact" && (
        <Card marginBottom="mb-8">
          ...
          <p className="text-gray-300 mb-6">
            ...
            contact us using the form below or through our social media
            channels.
          </p>
