...
**パス**: [ドキュメントガイド](../../README.md) > [開発者ガイド](../README.md) > [アーキテクチャ](./README.md)
...
- 中核ドキュメント（docs/README.mdとdocs/rules/structure.md）を整備し、ブレッドクラム・関連ドキュメントセクション・ディレクトリREADMEを活用する
...
- 2025/3/24: [変更] 「ドキュメントポータル」という用語を「中核ドキュメント」および「ドキュメントガイド」に変更
- 2025/3/23: [追加] 初回作成